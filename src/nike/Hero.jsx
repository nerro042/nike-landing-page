...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 w-full justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero  bg-cover bg-center">
        <img
          src={bigShoeImg}
          width={610}
          height={500}
          className="object-contain relative z-10 xl:mt-[100px]"
        />
